package kagg886.youmucloud.util.sudo;
...
public class SudokuFactory {
    //入门，初级，中级，高级，骨灰级
    private final byte[][] map = new byte[9][9];
    private final byte[][] title = new byte[9][9];
     ...
     * @return 返回 本对象
     */
    public static SudokuFactory create(int level) {
