...
@WebServlet("/bth")
public class OtherThink extends HttpServlet {
    ...
    public static String spawn(String url) throws IOException {
        BufferedImage image = ImageIO.read(new File(Statics.data_dir + "res/spawn/bth.png"));
        ...
        g.drawImage(source,538,7,520,478,null);
        g.drawImage(image,0,0,image.getWidth(),image.getHeight(),null);
        g.dispose();

        return ImageUtil.ImageToLink(model,"bth");
    }
}