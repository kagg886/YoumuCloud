package com.kagg886.youmucloud.core.widget;
...
public class canFetchDownListView extends ListView implements OnScrollListener {
    ...
    public canFetchDownListView(Context context) {
        super(context);
        init(context);
    }

    public canFetchDownListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    private void init(Context context) {
        setCacheColorHint(context.getResources().getColor(R.color.purple_200));
    ...
    private void changeHeaderViewByState() {
        switch (state) {
            ...
            case DONE:
                ...
                lvHeaderProgressBar.setVisibility(View.GONE);
                lvHeaderArrowIv.clearAnimation();
                lvHeaderArrowIv.setImageResource(android.R.drawable.arrow_down_float);
                lvHeaderTipsTv.setText("下拉刷新");
                lvHeaderLastUpdatedTv.setVisibility(View.VISIBLE);
                break;
        }
    ...
    public void onRefreshComplete() {
        state = DONE;
        lvHeaderLastUpdatedTv.setText("最近更新:" + new Date());
        changeHeaderViewByState();
    }
